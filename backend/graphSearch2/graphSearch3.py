...
class graphSearch(object):
    ...
    def getRelByType(self,type):
        ...
        :return:
        """
        uri = "http://10.10.1.202:8004/getRelByType?repertoryName=geo&type="+type
        r = requests.post(uri)
    ...
    def getProByType(self,type):
        ...
        :return:
        """
        uri = "http://10.10.1.202:8004/getProByType?repertoryName=geo&type="+type
        r = requests.post(uri)
    ...
    def getPredicate(self,label):
        ...
        uri = "http://10.10.1.202:8004/getProPredicate?repertoryName=geo&label="+label
        r = requests.post(uri)
        ans = list(r.json())
        if len(ans)>0:
    ...
    def getRelPredicate(self,label):
        ...
        :return:
        """
        uri = "http://10.10.1.202:8004/getRelPredicate?repertoryName=geo&label="+label
        r = requests.post(uri)
        predicate = list(r.json())[0]
    ...
    def getSubject(self, label):
        ...
        :return:
        """
        uri = "http://10.10.1.202:8004/getSubject?repertoryName=geo&label=" + label
        # print("label",label)
        r = requests.post(uri)
        subject = list(r.json())
    ...
    def getValueByPro(self,type,property):
        ...
        :return:
        """
        uri = "http://10.10.1.202:8004/getValueByPro?repertoryName=geo&entityType=" + type+"&property="+property
        r = requests.post(uri)
    ...
    def getValueByRel(self,type,property):
        ...
        :return:
        """
        uri = "http://10.10.1.202:8004/getValueByRel?repertoryName=geo&entityType=" + type+"&relation="+property
        r = requests.post(uri)
        value_list = list(r.json())
        return value_list
    ...
    def addTripleToRepertory(self,tripleList):
        ...
        data = {'repertoryName': 'geo', 'tripleList': str(tripleList)}
    ...
    def deleteProperty(self,label):
        ...
        print(propertyUri)
        data = {'repertoryName': 'geo', 'propertyUri': propertyUri}
    ...
    def addProperty(self,propertyName,pinyinName):
        ...
        data = {'repertoryName': 'geo', 'propertyName': propertyName, 'pinyinName':pinyinName}
    ...
    def addRelation(self, relationName, pinyinName):
        ...
        data = {'repertoryName': 'geo', 'relationName': relationName, 'pinyinName': pinyinName}
    ...
    def deleteTripleBySAP(self,subject,predicate):
        ...
        data = {'repertoryName': 'geo', 'subject': subject, 'predicate': predicate}
    ...
    def searchByEntity(self, entity):
        ...
        """获取属性信息"""
        uri = "http://10.10.1.202:8004/getEntityByLabelWithPro?repertoryName=geo&entityName=" + entity
        r = requests.post(uri)
        pro_list = list(r.json())

        """获取关系信息"""
        uri = "http://10.10.1.202:8004/getEntityByLabelWithRel?repertoryName=geo&entityName=" + entity
        r = requests.post(uri)
        rel_list = list(r.json())
    ...
    def searchEntityProName(self, entity):
        ...
        """获取属性信息"""
        uri = "http://10.10.1.202:8004/getEntityByLabelWithProName?repertoryName=geo&entityName=" + entity
        r = requests.post(uri)
        pro_list = list(r.json())
        return pro_list
    ...
    def getProList(self, entity):
        ...
        uri = "http://10.10.1.202:8004/getPro?repertoryName=geo&entity=" + entity
        r = requests.post(uri)
        pro_list = list(r.json())
    ...
    def getProByLabel(self,label):
        ...
        :return:
        """
        uri = "http://10.10.1.202:8004/getProByLabel?repertoryName=geo&label="+label
        r = requests.post(uri)
        pro_list = list(r.json())
    ...
    def getRelList(self, entity):
        ...
        uri = "http://10.10.1.202:8004/getRel?repertoryName=geo&entity=" + entity
        r = requests.post(uri)
        rel_list = list(r.json())
    ...
    def getEntityByType(self, etype):
        ...
        """获取子类"""
        uri = "http://10.10.1.202:8004/getEntityByType?repertoryName=geo&entityName=" + etype
        r = requests.post(uri)
    ...
    def getFatherByType(self, entity):
        ...
        """获取父类"""
        uri = "http://10.10.1.202:8004/getFatherByType?repertoryName=geo&entityName=" + entity
        r = requests.post(uri)
    ...
    def getEntityByRel(self, entity,property,keyword):
        ...
        uri = "http://10.10.1.202:8004/entitySearch?repertoryName=geo&entity="+entity+"&relation="+property+"&type="+keyword
        r = requests.post(uri)
        son_list = list(r.json())
